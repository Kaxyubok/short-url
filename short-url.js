...
let doc = document,
    ...
    content = '<div class="short-url hide">' +
        ...
        '<ul>' +
        '<li class="url-item baidu" data-to="baidu" data-clipboard-text="">' +
        '<div>百度</div>'+
        '</li>' +
        '<li class="url-item sina" data-to="sina" data-clipboard-text="">' +
        '<div>新浪</div>'+
        '</li>' +
        '<li class="url-item suoim" data-to="suoim" data-clipboard-text="">' +
        '<div>suo.im</div>'+
        '</li>' +
        '</ul>' +
        '</div>' +
